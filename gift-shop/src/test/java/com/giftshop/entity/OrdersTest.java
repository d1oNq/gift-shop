...
public class OrdersTest {
    ...
    public void testOrdersToString() {
        ...
        String expectedString = "Orders{orderId=1, userName='John Doe', email='john@example.com', phone='+1234567890', address='123 Main St, City', productName='Test Product', price='25.00', weight='1.5', payment='Credit Card'}";
