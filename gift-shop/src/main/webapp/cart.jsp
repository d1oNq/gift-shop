                    ...
                    <form action="order" method="post">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="inputName" placeholder="Ім'я" name="name" required="required"
                                       value="<%= user.getName() %>">
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="tel" class="form-control" id="inputPhone" placeholder="Телефон" name="phone" required="required"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputAddress" placeholder="Адреса" name="address" required="required"
                                       value="<%= user.getAddress() != null ? user.getAddress() : "" %>">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="inputCity">Місто</label>
                                <input type="text" class="form-control" id="inputCity" placeholder="Місто" name="city" required="required"
                                       value="<%= user.getCity() != null ? user.getCity() : "" %>">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="inputZip">Поштовий Індекс</label>
                                <input type="text" class="form-control" id="inputZip" placeholder="Індекс" name="zip" required="required"
